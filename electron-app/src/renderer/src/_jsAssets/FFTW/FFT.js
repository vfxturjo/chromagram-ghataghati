...
import { FFTWModule } from './FFTW'

export var fftwModule = FFTWModule({})

var fftwf_plan_dft_r2c_1d = fftwModule.cwrap('fftwf_plan_dft_r2c_1d', 'number', [
  'number',
  'number',
  'number',
  'number'
...
var fftwf_plan_dft_c2r_1d = fftwModule.cwrap('fftwf_plan_dft_c2r_1d', 'number', [
  'number',
  'number',
  'number',
  'number'
...
var fftwf_plan_r2r_1d = fftwModule.cwrap('fftwf_plan_r2r_1d', 'number', [
  'number',
  'number',
  'number',
  'number'
...
var fftwf_execute = fftwModule.cwrap('fftwf_execute', 'void', ['number'])

var fftwf_destroy_plan = fftwModule.cwrap('fftwf_destroy_plan', 'void', ['number'])
